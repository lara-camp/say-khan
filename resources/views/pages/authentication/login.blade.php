                ...
                <div class="w-80  mb-5 min-w-fit">
                    <div class="py-2">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" placeholder="Email" required
                            class="w-full bg-purple bg-transparent border-2 font-thin border-white p-4 pl-20 text-b1  tracking-widest rounded-xl focus:border-black placeholder-white">
                        @error('email')
                    ...
                    <div class="py-2">
                        ...
                        <input type="password" placeholder="Password" name="password" required
                            class="w-full bg-purple bg-transparent  border-2 border-white p-4 pl-20 text-b1 tracking-widest rounded-xl focus:border-black placeholder-white">
                        @error('password')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                    </div>
