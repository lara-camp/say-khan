        ...
        <div class="flex items-start  justify-around w-full">
            ...
            <div class="w-2/3 ">
                ...
                <div class="w-full  flex justify-between px-5 gap-4">
                    ...
                    <small style="color: red">{{ $message }}</small>
                    @enderror
                       <input type="text" class=" bg-white bg-transparent  border-2 border-purple mb-5 px-6 rounded-lg h-12 text-b1 tracking-widest font-thin " name="phone" id="phone" value="{{ old('phone') }}"  placeholder=" Enter Phonenumber..">
                       @error('phone')
                       <small style="color: red">{{ $message }}</small>
                   @enderror
                ...
                <div class="px-14 ">
                    ...
                    <span class=" px-2 text-gray "><a href="" class=" px-2 text-gray ">Sign In Here</a></span>
                </div>
